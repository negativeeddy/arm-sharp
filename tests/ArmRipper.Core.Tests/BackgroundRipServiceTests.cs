...
public sealed class BackgroundRipServiceTests
{
    ...
    public async Task StartRip_CreatesScopeAndRunsConductor()
    {
        ...
        var service = new BackgroundRipService(scopeFactory.Object, NullLogger<BackgroundRipService>.Instance, CreateSettings(), _ => true);
    ...
    public async Task StartRip_WhenExistingJobIsTranscoding_StartsNewPipeline()
    {
        ...
        var service = new BackgroundRipService(fix.ScopeFactoryMock.Object, NullLogger<BackgroundRipService>.Instance, CreateSettings(), _ => true);
